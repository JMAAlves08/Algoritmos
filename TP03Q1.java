 ...
 */
class No extends Time {
	private Time elemento; // Conteudo do no.
	private No esq, dir;  // Filhos da esq e dir.
        /*Gets e sets*/
        void set_elemento(Time elemento){
...
public class TP03Q1 {
    ...
    public static void main(String[] args) throws Exception{
		...
		a1.remover("África do Sul");
a1.remover("Alemanha");
a1.remover("Argentina");
a1.remover("Brasil");
a1.remover("Chile");
a1.remover("Coreia do Sul");
a1.remover("Espanha");
a1.remover("Estados Unidos");
a1.remover("França");
a1.remover("Inglaterra");
a1.remover("Itália");
a1.remover("Japão");
a1.remover("México");
a1.remover("Suécia");
...
a1.remover("Uruguai");
        ...
        for(arq=MyIO.readLine(); Equals(arq, "FIM")==false; arq=MyIO.readLine()){
			MyIO.print(arq+" raiz");
			if(a1.pesquisar(arq)){ MyIO.print(" SIM\n"); }
			else{ MyIO.print(" NÂO\n"); }
