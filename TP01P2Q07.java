...
/**
  ...
  */
   ...
   void get_partida(String file, int vez){
      ...
      Arq.openRead("/tmp/copa/"+file+".html", "r");//abrir arquivo
...
public class TP01P2Q07{
  ...
  */
   ...
   public static void main (String [] args){
      ...
      String arquivo="";
      String teste="Alemanhha Ocidental";
      int c=0;
      int p=0;//ponteiro
      int t=1;
      int comp=0;
      ...
      //PESQUISA 
      for(arquivo=MyIO.readLine(); Equals(arquivo, "FIM")==false; arquivo=MyIO.readLine()){
        MyIO.println(arquivo+" -- "+r1.pesquisaseq(arquivo));
      }//for
      long end=System.currentTimeMillis();
      time=end-begin;
      try{
         FileWriter file = new FileWriter(new File("matricula_sequencial.txt"));//criar arquivo log
         file.write("600092\t"+time+"\t"+r1.get_comp());
         file.close();
      } catch(IOException e){ }
   }//main
}//class
