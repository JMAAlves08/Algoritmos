  ...
  for(c2=0; c2<q; c2++){
    ...
    if(valor.charAt(0)=='I'){//inserções
      if(valor.charAt(1)=='I'){ //inseririnicio
        ...
        i1.ler(tmp); l1.inseririnicio(i1); i1 = new Inst();
      }//inseririnicio
      else if(valor.charAt(1)=='F'){//inserirfim
        for(c=3; c<valor.length(); c++){ tmp+=valor.charAt(c);}//pegar linha da instituição
        i1.ler(tmp); l1.inserirfim(i1); i1 = new Inst();
      }//inserirfim
      else{//inserir
        ...
        i1.ler(tmp); l1.inserir(i1, Integer.parseInt(pos)); i1= new Inst();
      }//inserir
    }//inserções

    else{
      if(valor.charAt(1)=='I'){ r1.inserirfim(l1.removerini()); }//removerinicio
      else if(valor.charAt(1)=='F'){r1.inserirfim(l1.removerfim());}//removerfim
      else{ //remover
        ...
        r1.inserirfim(l1.remover(Integer.parseInt(pos)));
      }
    }
    tmp=""; pos="";
  }//for
