...
class Lista extends Partida{
   ...
   Partida removerFim(){
      ...
      p1=vetor[n-1];//pegando valor da ultima posicao
...
/**
  ...
  */
   ...
   public static void main (String [] args){
   	...
   	//dados
      Lista v1 = new Lista(200);
      Lista v2 = new Lista(20); //vetor para armazenar os elementos removidos
